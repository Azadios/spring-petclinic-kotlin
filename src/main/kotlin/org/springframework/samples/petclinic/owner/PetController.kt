...
class PetController(val pets: PetRepository, val owners: OwnerRepository) {
    ...
    /**
     * Adds the available pet types to every pet form model.
     */
    @ModelAttribute("types")
    fun populatePetTypes(): Collection<PetType> = this.pets.findPetTypes()

    /**
     * Loads the owner identified by the request path for pet form handling.
     */
    ...
    /**
     * Registers the custom pet validator for pet form submissions.
     */
    @InitBinder("pet")
    ...
    /**
     * Prepares the form used to add a new pet to the current owner.
     */
    @GetMapping("/pets/new")
    ...
    /**
     * Prepares the form used to update an existing pet.
     */
    ...
    /**
     * Validates and saves updates to an existing pet.
     */
